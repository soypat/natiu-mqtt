...
func TestTypeMatchesReflectType(t *testing.T) {
	t.Run("Slice", func(t *testing.T) {
		testHeaderMatchesReflect(t, unsafeSlice{}, reflect.SliceHeader{})
	})

	t.Run("String", func(t *testing.T) {
		testHeaderMatchesReflect(t, unsafeString{}, reflect.StringHeader{})
	})
}
...
func TestWriteThroughHeader(t *testing.T) {
	t.Run("Slice", func(t *testing.T) {
		...
		var alias []byte
		hdr := (*unsafeSlice)(unsafe.Pointer(&alias))
	...
	t.Run("String", func(t *testing.T) {
		...
		var alias string
		hdr := (*unsafeString)(unsafe.Pointer(&alias))
